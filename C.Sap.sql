...
1inner join libdebito.tbctra0p c on c.txctrx = a.opcodtrn
...
INNER JOIN gxbdbps.CODTOAF X ON (k.CODDTO = X.CODDTO)
WHERE LFECTR BETWEEN  '20220621' AND '20220621'  AND enttipo = 'CRE'
...
WHERE LFECTR BETWEEN  '20220621' AND '20220621' AND lenemi ='002' AND enttipo = 'CRE'
...
LIFECREDI >=  '20220701' and  LIFECREDI <='20220729'
--and substr(LICOMER,1,2) = '81'
...
where RFEPRO between '20220101' AND '20220701' 
...
INNER JOIN libdebito.tbcret0p ON lcretr = CODNRO
inner join libdebito.tbctra0p on txctrx = lcodtr
WHERE LFECTR BETWEEN '20220621' AND '20220621'
...
from gxbdbps.TMPNUM 
where numfch between '20220621' and '20220621' and mcnumct = '2030000190'
...
where opfecom BETWEEN '20220621'  AND '20220621' and openemi BETWEEN '300' AND '400'
...
/*where lifecredi between '20191031' and '20220621' and licomer = '0301556'*/
select * from libdebito.tbctra0p

[16:53] Maria Veronica Ovelar
...
where movfpro BETWEEN '20220101' AND '20220131'
and movpgon = 'O' and movruc = '80057902-0' and movesta = 'A'
UNION
...
--WHERE SUBSTR(movfpro,1,4)||'-'||SUBSTR(movfpro,5,2)||'-'||SUBSTR(movfpro,7,2) = DATE(CURDATE()- 1 days)
where movfpro BETWEEN '20220101' AND '20220131'
and movpgon = 'O' and movruc = '80057902-0' and movesta = 'R'UNION
...
--WHERE SUBSTR(movfpro,1,4)||'-'||SUBSTR(movfpro,5,2)||'-'||SUBSTR(movfpro,7,2) = DATE(CURDATE()- 1 days)
where movfpro BETWEEN '20220101' AND '20220131'
and movpgon = 'B' and movruc = '80057902-0' AND SERCODI <> 'REDPAG'
UNION
/*Transacciones Aprobadas Batch = Red de pagos*/
Select movfpro,movftrx fechatrx, movrrnbep nrotransaccion, (CASE WHEN movtpta = 'D' THEN 'DEBITO' ELSE 'CREDITO' END) tipotarjeta, movcoau Autorizacion, movdesem Emisor, substr(movntar,1,6)||'XXXXXX'||substr(movntar,13,4) tarjeta,
movmarc marca, 1 cuotas, '600' moneda, movcoam origen, movcomer codsucursal, movdeno sucursal, a.sercodi tipo, movcodpr procesadora,
