...
where lfectr='20220127' and   lcodbc = 'MST' and codmar='MSTC'
...
where lfectr='20220127' and   lcodbc = 'VSA' and codmar='VISA'
and lenemi='540'
...
where lfectr='20220127' and codmar='BEPS'--and   lcodbc = 'DIN' and
...
right join libdebito.tbcret0p on lcretr = codnro
right join gxbdbps.gentiaf ON (ENEMISO=LENemi)
where lfectr='20220127' and codmar='BEPS' and lcodbc = 'DIN'
