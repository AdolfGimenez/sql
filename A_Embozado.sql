...
/*
  Tipos de Novedad de Embozado Actual
     ...
     4    Renovación por Vto.
     5    Reimpresión de PIN
...
and CRCODN<>'5'       
------------------------------------------------------------------------------------------------------------------------------------------
--Verificamos que la entidad remitio un pedido en fecha del mes de marzo, y el mismo no fue concluido, podrían verificar por favor el motivo y ayudarnos a procesar el día de hoy. Adjunto tarjeta en cuestion.
...
------------------------------------------------------------------------------------------------------------------------------------------
--Favor verificar inconveniente para reimpresion de PIN, la entidad solicitó una reimpresion de pin pero Operaciones no registra para su proceso
select * from GXBDBPS.TDEMISnov  where  TDEMISNOV='5' and TDESTNOV='0'
