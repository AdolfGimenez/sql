...
gxbdbps.lgcoment where lgmsg like (nro referencia)
------------------------------------------------------------------------------------------------------------------------------------------
visa.vistrndta where virrnbepsa
--mensajeria iso8583
------------------------------------------------------------------------------------------------------------------------------------------ 
...
from libdebito.drconbep where lfectr between '20221028' and '20221028'
...
SELECT * FROM LIBDEBITO.DRCONBEP WHERE  LENEMI='152'
