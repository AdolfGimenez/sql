----------------------------------------------------------------------------------------------
SELECT * FROM GXOPERA.TRXINST where insPGENTID = '18454  ';
DELETE GXOPERA.TRXINST where insPGENTID= '18454  ';
----------------------------------------------------------------------------------------------
SELECT * FROM GXOPERA.FLICOM WHERE LINRO ='18454  '; --WHERE LICOMER = '1302527' and LIFECHD='20220908';
delete GXOPERA.FLICOM WHERE LINRO ='18454  ';  --where LICOMER = '1302527' and LIFECHD='20220908';
----------------------------------------------------------------------------------------------
SELECT * FROM GXOPERA.FLICOM1 WHERE LINROINS ='18454    '; --WHERE LICOMER = '1302527' and LIFECHD='20220908'; 
delete GXOPERA.FLICOM1 WHERE LINROINS ='18454  ';--WHERE LICOMER = '1302527' and LIFECHD='20220908';  
----------------------------------------------------------------------------------------------
SELECT sum(INSFACTOT) FROM GXOPERA.TRXINST where insPGENTID = '18454  ';
SELECT sum(LIMONTO) FROM GXOPERA.FLICOM1 WHERE LINROINS ='18454  ';
