...
Select cocomer, codeno, corazo, cofiva vigencia, (case when coreten = 0 then 'TODOS' when coreten = 1 then 'RENTA' when coreten = 2 then 'IVA' else 'NINGUNO' END)APLICA
from gxbdbps.comaeaf where cocomer = '0801448';
----------------BILLETERAS----------
...
--------------------TARJETA DINELCO------------------
--8va pestaña Tarjeta Dinelco 703020
