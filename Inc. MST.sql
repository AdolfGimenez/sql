--Controlar archivos T113
select * from gxbdbps.ipmdtaT where ipmfname = 'T113203672'
...
WHERE w.IPMFNAME IN ('T113208454','T113208455') AND
--WHERE w.IPMFNAME ='T113206113' AND
w.IPMMTI = 1240 AND
w.IPMFNC = 200 AND
w.IPMDELN = 63)
SELECT
...
WHEN p.PRODUCTO = 'MAB' AND SUBSTR(p.IRD, 1, 2)= '75' THEN 'IP'
WHEN p.PRODUCTO = 'MCF' AND SUBSTR(p.IRD, 1, 2)= '75' THEN '63'
WHEN p.PRODUCTO = 'MNW' AND SUBSTR(p.IRD, 1, 2)= '75' THEN 'ES'
WHEN p.PRODUCTO = 'MDS' AND SUBSTR(p.IRD, 1, 2)= '75' THEN '85'
WHEN p.PRODUCTO = 'SUR' AND SUBSTR(p.IRD, 1, 2)= '75' THEN '85'
WHEN p.PRODUCTO = 'MCS' AND SUBSTR(p.IRD, 1, 2)= '75' THEN '85'
WHEN p.PRODUCTO = 'MCC' AND SUBSTR(p.IRD, 1, 2)= '75' THEN '95'
WHEN p.PRODUCTO = 'TPL' AND SUBSTR(p.IRD, 1, 2)= '75' THEN 'PS'
WHEN p.PRODUCTO = 'MTP' AND SUBSTR(p.IRD, 1, 2)= '75' THEN 'PS'
WHEN p.PRODUCTO = 'MDJ' AND SUBSTR(p.IRD, 1, 2)= '75' THEN '85'
WHEN p.PRODUCTO = 'TCS' AND SUBSTR(p.IRD, 1, 2)= '75' THEN '85'
WHEN p.PRODUCTO = 'MDU' AND SUBSTR(p.IRD, 1, 2)= '75' THEN '95'
WHEN p.PRODUCTO = 'MCT' AND SUBSTR(p.IRD, 1, 2)= '75' THEN 'PS'
ELSE '??'
...
--------------------------------------------------------------*
--Para Mastercard
SELECT * FROM GXBDBPS.IPMFCTL WHERE IPMFCNAME like 'T1402028%' AND IPMFFECPRO = '20220128'
