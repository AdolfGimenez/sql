...
----log de entidad para todos dinelco.
SELECT * FROM LIBDEBITO.ENTFIL001 WHERE ENTDATMSG LIKE '%305052078242%' AND DATE (ENTFECGRA)='2023-02-19' order BY 1;
---------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
...
lbinpr as Bin , lcodbc as Marca , limpgs as Monto,lesttr as Estado,lcretr as Retorno,lhisde as Respondido_Por ,leca62 as ATM ,loritr as ATM_POS,lerrnb as Referencia ,lbcocr
from libdebito.drconbep
where lfectr='20230219'/*between '20230219' and '20220704'*/ and lenemi='088' --and lnrtar like '627431162%'
order by lhortr desc;
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lbinpr as Bin , lcodbc as Marca , limpgs as Monto,lesttr as Estado,lcretr as Retorno,lhisde as Respondido_Por ,leca62 as ATM ,loritr as ATM_POS,lerrnb as Referencia ,lbcocr
from libdebito.drconbep
where lfectr='20230219'/*between '20230219' and '20220704'*/ and lenemi='165' --and lnrtar like '627431162%'
order by lhortr desc;
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
